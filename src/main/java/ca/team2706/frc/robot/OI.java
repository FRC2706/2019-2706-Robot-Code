...
public class OI {
    ...
    public OI(Joystick driverStick, Joystick controlStick) {
        ...
        new FluidButton(controlStick, Config.SLIGHTLY_LIFT_LIFT_BINDING)
                .whenPressed(new MoveLiftToPosition(0.5, () -> Lift.getInstance().getLiftHeight() + 1.4));
