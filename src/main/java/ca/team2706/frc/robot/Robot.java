...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        commands = new Command[]{
                ...
                new CurveDrive2(0.2, new Waypoint[] {
                        new Waypoint(-1.5, -1, Pathfinder.d2r(-45)),      // Waypoint @ x=-4, y=-1, exit angle=-45 degrees
                        new Waypoint(-1, -2, 0),                        // Waypoint @ x=-2, y=-2, exit angle=0 radians
