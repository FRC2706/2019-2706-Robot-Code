...
public class ApproachSecondSideCargoRight extends MirroredCommandGroup {

    public ApproachSecondSideCargoRight() {
        addMirroredSequential(new FollowTrajectoryFromFile(1.0, 10, "FirstSideCargoRight"));
    }
}
