...
public class LevelOneCentreHatch extends CommandGroup {
    ...
    public LevelOneCentreHatch() {
        ...
        addSequential(new MotionMagic(() -> 12.5, () -> 10, () -> -10.0 * OI.getInstance().getDriverStick().getRawAxis(XboxValue.XBOX_RIGHT_STICK_X.getPort())), 4);
        addSequential(new PlaceHatchAuto());
        addSequential(new StraightDriveGyro(-2, 10));
    }
}
