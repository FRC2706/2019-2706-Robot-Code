...
public class FollowTrajectoryTest {
    @Mocked
    ...
    /**
     * Tests dual trajectory
     */
    @Test
    public void testDualTrajectory() {
        ...
        new Verifications() {{
            ...
            // FIXME: Position doesn't seem to be affected by generating dual trajectory
            // assertTrue(trajectories.get(0)[1].position < trajectories.get(1)[1].position);
        }};
    }

    /**
     * Tests single trajectory
     */
    @Test
